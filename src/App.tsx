        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          >
            <div className="w-10 h-10 bg-zinc-900 border border-zinc-800 rounded-xl overflow-hidden flex items-center justify-center transition-all duration-300 group-hover:scale-105 active:scale-95 shadow-[0_0_20px_rgba(250,204,21,0.15)]">
              <img 
                src="https://firebasestorage.googleapis.com/v0/b/wikistars5-465e1.firebasestorage.app/o/logo%2Festrellados%20192.jpg?alt=media&token=4dd91800-784b-414c-8771-2b3dddb1c47e" 
                alt="Starryz5 Logo" 
        ...
        <div className="fixed inset-0 z-40 bg-black overflow-y-auto pt-20 pb-24 p-4 sm:p-6">
          <div className="max-w-md mx-auto space-y-6">
            ...
            {!currentUser || !auth.currentUser ? (
              <div className="bg-[#0b0b0c] border border-zinc-900 rounded-2xl p-8 flex flex-col items-center text-center space-y-6 shadow-xl">
                ...
                <div className="space-y-2">
                  <h3 className="text-white font-sans font-black text-xl tracking-tight">
                    Inicia Sesión en Starryz5
                  </h3>
                  <p className="text-sm text-zinc-400 leading-relaxed font-sans max-w-sm">
                    Para ver tu perfil, personalizar tu avatar y editar tus datos de estudiante, por favor inicia sesión con tu cuenta de Google.
                  </p>
                </div>
                ...
                <button
                  type="button"
                  onClick={handleGoogleSignIn}
                  className="w-full bg-white hover:bg-zinc-100 text-black font-sans font-bold text-sm py-4 px-6 rounded-xl flex items-center justify-center gap-3 transition-all duration-200 cursor-pointer shadow-lg active:scale-[0.98]"
                >
